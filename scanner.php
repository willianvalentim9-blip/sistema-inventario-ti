...
function addProductWithCode() {
    if (lastScannedCode) window.open(`add_product.php?code=${encodeURIComponent(lastScannedCode)}`, '_blank');
}

function addMachineWithCode() {
    if (lastScannedCode) window.open(`add_machine.php?code=${encodeURIComponent(lastScannedCode)}`, '_blank');
}
...
async function searchCode() {
    ...
    try {
        const response = await fetch('search_code.php', {
            method: 'POST',
