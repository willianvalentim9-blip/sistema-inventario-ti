            ...
            <div class="card card-custom">
                ...
                <div class="card-body text-center p-4" id="printable-area">
                    ...
                    <div class="barcode-info">
                        <p class="font-monospace h5" id="barcode-text"><?php echo htmlspecialchars($code); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="range" class="form-range" id="barcode-width" value="2" min="1" max="5" oninput="updateBarcode()">
                        </div>
                        <div class="col-md-4">
