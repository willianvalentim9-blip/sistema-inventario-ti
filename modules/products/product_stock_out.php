...
if ($product_id > 0) {
    try {
        ...
        if (!$product) {
            ...
            $error_message = 'Este produto não possui estoque para dar baixa.';
        }
...
<form id="stockOutForm" action="give_stock_out.php" method="POST" autocomplete="off">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control form-control-custom" id="quantity" name="quantity" required min="1" max="<?php echo $product['quantity']; ?>" value="1">
        </div>
        <div class="col-md-6 mb-3">
