        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td><div class="btn-group btn-group-sm">
                    ...
                    <a href="../barcode/barcode_print.php?product_id=<?php echo $product['id']; ?>" class="btn btn-outline-info" data-bs-toggle="tooltip" title="Imprimir Código de Barras" target="_blank"><i class="fas fa-barcode"></i></a>
